...
alter table if exists app_data.saml2_identity_provider_slo_endpoint add constraint fk_sso_bnd foreign key (bnd_id) references app_data.saml2_endpoint_binding (bnd_id);
