...
,       constraint uk_idp_nm        unique      (tnt_id, idp_nm)
,       constraint uk_idp_entity_id unique      (tnt_id, idp_entity_id)
,       constraint ck_idp_nm        check       (length(trim(idp_nm))        > 0 and idp_nm        = trim(idp_nm))
