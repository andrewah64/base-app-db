...
,       constraint ck_spc_nm         check       (length(trim(spc_nm))     > 0 and spc_nm     = trim(spc_nm))
,       constraint ck_spc_cn_nm      check       (length(trim(spc_cn_nm))  > 0 and spc_cn_nm  = trim(spc_cn_nm))
,       constraint ck_spc_org_nm     check       (length(trim(spc_org_nm)) > 0 and spc_org_nm = trim(spc_org_nm))
